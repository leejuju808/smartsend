-- =========================================================
-- Block 21395 — SmartSend Roofing Daily Action List ("Today" View)
-- =========================================================

-- ============================================================================
-- PART 1 — RPC Functions for Today's Action List
-- ============================================================================
...
COMMENT ON FUNCTION public.get_warm_jobs_needing_followup IS 'Returns warm jobs where last outbound was sent >= 2 days ago with no inbound reply since then';
COMMENT ON FUNCTION public.get_cold_jobs_to_revive IS 'Returns cold jobs created in last 30 days with no inbound reply yet';
