-- Adaptive Warmup Ramp Tracking System (Idempotent)
-- Historical warmup stats, adaptive recalculation, and engagement-based ramp adjustment
...
drop trigger if exists trg_warmup_history_updated_at on public.warmup_history;
create trigger trg_warmup_history_updated_at
before update on public.warmup_history
for each row
execute function public.set_updated_at();

-- B) Link to account_warmup_profiles (Block 121)
