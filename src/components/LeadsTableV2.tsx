...
interface Lead { id: string; email: string; first_name: string | null; last_name: string | null; company: string | null; status: string; campaign_id: string | null; created_at: string; }

export default function LeadsTableV2() {
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="border rounded overflow-hidden">
        <div className="grid grid-cols-8 gap-2 p-2 bg-muted text-xs font-medium items-center">
        ...
        {loading ? (
          ...
          data.map((d) => (
            <div key={d.id} className="grid grid-cols-8 gap-2 p-2 border-t items-center">
